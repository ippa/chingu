...
=== Chingu::Actor
This is our basic "gameunit"-class, meaning most ingame objects (players, enemies, bullets etc) should be inherited from Chingu::Actor. The basic ideas behind it are:
...
I've chose to base it around Image#draw_rot. So basicly all the arguments that you pass to draw_rot can be passed to Actor#new when creating a new object, an example using almost all arguments would be:
