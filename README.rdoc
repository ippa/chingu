...
Links to some of the projects using/depending on Chingu:
  ...
  https://github.com/ippa/the_light_at_the_end_of_the_tunnel  An LD entry 
  https://github.com/ippa/gnorf Another LD entry, decent minigame with online highscores!
  ...
  https://github.com/ippa/whygone A odd little platformer-puzzle-game for _why day
  https://github.com/erisdiscord/gosu-tmx a TMX map loader
  https://github.com/rkachowski/tmxtilemap Another TMX-class
  https://github.com/erisdiscord/gosu-ring Secret of Mana-style ring menu
  https://github.com/deps/Berzerk remake of the classic
  https://github.com/rkachowski/tigjamuk10 "sillyness from tigjamuk - CB2 bistro in Cambridge, January 2010"
  https://github.com/zukunftsalick/ruby-raid Remake of ataris river raid, unsure of the status
